 ...
 * Этап 7: расчёт эффективности — детерминированный (executor: 'calc').
 *
 ...
 *
 * calc — ДЕТЕРМИНИРОВАННЫЙ расчёт (TZ §5): число из проверяемого кода, не из LLM.
 */
...
/**
 * Детерминированный расчёт эффективности (TZ §5).
 * Формулы, bootstrap, сценарии, пороги — программно; LLM не участвует.
 */
registry.set('calc', calcExecutor)
